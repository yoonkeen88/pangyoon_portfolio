    ...
    <div className="min-h-screen pt-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">안녕하세요, 개발자입니다</h1>
        ...
        <Card className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm mb-8">
          ...
          <CardContent className="space-y-4">
            <p className="text-gray-700 dark:text-gray-300">
              안녕하세요! 저는 3년차 풀스택 개발자로, 사용자 중심의 웹 애플리케이션을 개발하는 것에 열정을 가지고
              있습니다. React와 Next.js를 주로 사용하여 프론트엔드를 개발하고, Node.js와 Python으로 백엔드 시스템을
              구축합니다.
            </p>
            <p className="text-gray-700 dark:text-gray-300">
              최근에는 데이터 분석과 머신러닝에도 관심을 가지고 있어, Python을 활용한 데이터 시각화와 예측 모델 구축
              프로젝트를 진행하고 있습니다. 새로운 기술을 학습하고 이를 실제 프로젝트에 적용하는 것을 즐깁니다.
            </p>
            <p className="text-gray-700 dark:text-gray-300">
        ...
        <Card className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm mb-8">
          ...
          <CardContent className="space-y-4">
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white">컴퓨터공학과 학사</h3>
              <p className="text-gray-600 dark:text-gray-400">OO대학교 (2018 - 2022)</p>
            </div>
            <div>
