...
import { updateProfile, updateAboutSection, deleteAboutSection } from "@/lib/profile-service"
...
export function AboutPageClient({
  ...
  useEffect(() => {
    ...
    setAboutSections(initialAboutSections)
    setSkills(initialSkills)
    setEducations(initialEducations)
    setInterests(initialInterests)
  }, [initialProfile, initialAboutSections, initialSkills, initialEducations, initialInterests])
  ...
  const isOwner = user && profile && user.id === profile.user_id && isAdmin
